module attributes {ark.build.unit = "/home/mrkj/ark/benchmarks/bench_modadd.ark"} {
  ...
  llvm.mlir.global private constant @".str.440862352165725093"("checksum:\00") {addr_space = 0 : i32}
  llvm.func @main() -> i32 attributes {ark.domain = "host", llvm.emit_c_interface} {
    ...
    %2 = llvm.mlir.addressof @".str.440862352165725093" : !llvm.ptr
  ...
  ^bb3:  // pred: ^bb2
    ...
    llvm.br ^bb1
  ^bb4:  // pred: ^bb1
    %26 = llvm.getelementptr %2[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<10 x i8>
