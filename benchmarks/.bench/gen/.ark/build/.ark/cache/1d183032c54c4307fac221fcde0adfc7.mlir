module attributes {ark.build.unit = "/home/mrkj/ark/benchmarks/.bench/gen/bench_modadd_n_20000000.ark"} {
  llvm.func @printNewline()
  llvm.func @printI32(i32)
  llvm.func @printSpace()
  llvm.func @printStr(!llvm.struct<(ptr, i64)>)
  llvm.mlir.global private constant @".str.15656253519768767820"("ark checksum:\00") {addr_space = 0 : i32}
  llvm.func @main() -> i32 attributes {ark.domain = "host", llvm.emit_c_interface} {
    ...
    %2 = llvm.mlir.addressof @".str.15656253519768767820" : !llvm.ptr
    %3 = llvm.mlir.constant(0 : i32) : i32
    %4 = llvm.mlir.constant(1000000007 : i32) : i32
    %5 = llvm.mlir.constant(20000000 : i32) : i32
